...
**Claude Code masaüstü** uygulamasında:

1. Settings → Plugins'i açın
2. **Add plugin**'e tıklayın
3. Size gönderdiğimiz kurulum URL'sini yapıştırın
4. **Install**'a tıklayın, ardından Claude Code'u yeniden başlatın

Eklenti listenizde `agency-starter` görünmelidir.
...
`/setup-help` yazın. Ne yapıyor olduğunuzu yakalayıp paylaşılan destek kanalımıza gönderir. Genellikle 4 iş saati içinde yanıtlarız.
